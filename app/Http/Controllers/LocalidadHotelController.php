...
class LocalidadHotelController extends GeneralController
{
    /**
    ...
    {
      $response1=$this->consumeAPI('GET','api/localidads/'.$localidad_id);
      $localidad=$response1->data;
      $links=$localidad->links;
