            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div>
                    ...
                    <form method="POST" action="{{route('alojamientos.habitacions.reservas.reservar',[$alojamiento->identificador,$habitacion->identificador])}}">
                      @csrf
                      ...
                      <div class="form-group row">
                          ...
                          <div class="col-md-6">
                              <input id="tarjeta" type="text"  class="form-control" name="tarjeta" value="{{$tarjeta->numero}}" readonly required/>
